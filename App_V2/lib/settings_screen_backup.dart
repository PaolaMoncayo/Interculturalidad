  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        final Color primaryGreen = accessibilityProvider.getAccessibleGreen(accessibilityProvider.highContrastMode);
        final Color lightGreen = accessibilityProvider.getAccessibleLightGreen(accessibilityProvider.highContrastMode);
